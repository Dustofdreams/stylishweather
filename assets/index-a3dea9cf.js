          ...
          <div class="card card-sm highlight-card one">
            ...
            <div class="wrapper">
              ...
              <ul class="card-list">
                ...
                <li class="card-item">
                  <p class="title-1">${v.toPrecision(2)}</p>

                  <p class="label-1">Серен диоксид</p>
                </li>

                <li class="card-item">
                  <p class="title-1">${L.toPrecision(2)}</p>

                  <p class="label-1">Азотен диоксид</p>
                </li>

                <li class="card-item">
                  <p class="title-1">${r.toPrecision()}</p>
            ...
            <span class="badge aqi-${n} label-${n}" title="${P[n].message}">
              ${P[n].level}
            </span>
